...
import { PostsTestManager, createMockBlog, BlogsTestManager, createMockPost } from '../helpers/test-helpers';
...
describe('PostsController (e2e)', () => {
  ...
  describe('/posts (e2e)', () => {
    ...
    // relations - это tables
    // high cohesion/low coupling (GRASP)
    // logging: true (для typeorm)
    // factory method
    // business rules/ business invariants
    // bounded context: account: user -> user; payments: user -> client
    // aggregate root DDD
    // transaction, commit
